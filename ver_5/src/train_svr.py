...
file_handler1 = logging.FileHandler(f"{log_dir}/{today}_train_svr_info.log")
file_handler1.setLevel(logging.INFO)

file_handler2 = logging.FileHandler(f"{log_dir}/{today}_train_svr_debug.log")
...
def best_combination(
    ...
    for combi in combinations:
        ...
        row = {
            ...
            "best_kernel": str(clf.best_estimator_.named_steps["svr"].kernel_),
        }
